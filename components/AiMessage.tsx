  ...
  return (
    <div className="absolute left-[10vw] bottom-[40vw]">    
      <div className="relative">  
        <div className="relative w-[80vw] h-[5vw] bg-[#ffb84d] z-[10]" style={{
      ...
      <div className="relative">
        <div className="text-center px-[3vw] py-[1vw] relative w-[80vw] bg-[#ffb84d]">{children}</div>
      ...
      <div className="relative">
        <div className="relative w-[80vw] h-[5vw] bg-[#ffb84d]" style={{
      ...
      <div className="relative">
        <div className="relative w-[8vw] h-[8vw] bg-[#ffb84d] ml-[10vw]" style={{
          clipPath: 'polygon(0 0, 8vw 0, 0 8vw)',
        }}></div>
        <div className="absolute top-0 left-[0.4vw] w-[8vw] h-[8vw] bg-[#070707] ml-[10vw]" style={{
          clipPath: 'polygon(0 0, 8vw 0, 0 8vw)',
